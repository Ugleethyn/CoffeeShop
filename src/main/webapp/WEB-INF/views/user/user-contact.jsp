            ...
            <nav class="navbar navbar-expand-lg navbar-light ">
                ...
                <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/user/contact" class="nav-link active">Contact</a>
                        </li>
            ...
            <div class="container section-ourTeam">
                <div class="row">
                    <div class="col-md-12 ourTeam-hedding text-center">
                        <h1>Contact</h1>
                        <p>You can easy contact with us via our live chat or you can send an e-mail at the following address<br>
                            You can also send us a message to our social  media </p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="row section-info ourTeam-box text-center">
                            <div class="col-md-12 section1">
                                <a href="${pageContext.request.contextPath}/user/chat"><img src="${pageContext.request.contextPath}/img/livechat.png"></a>
                            </div>
                            <div class="col-md-12 section2">
                                <p>Live Chat</p>
                            </div>
