                            ...
                            <tbody>
                                ...
                                <c:forEach items="${orders}" var = "order">
                                    <tr>
                                        ...
                                        <td class="orderrow">${order.addressid.street} ${order.addressid.number} ${order.addressid.city}, ${order.addressid.zipcode}</td>
                                        <td class="orderrow"><c:forEach items="${order.orderDetails}" var = "orderDetail">x${orderDetail.quantity} ${orderDetail.product.pname}<br></c:forEach></td>
                                        </tr>
                                </c:forEach>
                            </tbody>
                        </table>
