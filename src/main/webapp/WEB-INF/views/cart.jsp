                    ...
                    <aside class="col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr> <a href="checkout.html"><button class="button cartbtn"><span>Submit Order </span></button></a>
                                <a href="menu.html"><button class="button cartbtn"><span>Continue Shopping </span></button></a>
                            </div>
                        </div>
                    </aside>
                </div>
